    ...
    <section className="pixel-box-lg bg-card">
      <div className="grid items-stretch gap-0 md:grid-cols-[1.1fr_1fr]">
        ...
        <button
          ...
          className="pixel-checker group relative aspect-square w-full overflow-hidden border-b-4 border-foreground md:aspect-auto md:min-h-[420px] md:border-b-0 md:border-r-4"
        >
          <Image
            key={piece.slug}
