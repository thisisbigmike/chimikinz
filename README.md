...
- **Metakiddo** — Founder / Art & Lore
- **CHIMIJEE** — Vibes & Events

---

## 🛠️ Tech Stack & Local Development

This web application powering the Chimikinz brand, gallery, and quest platform is built using:

- **Framework**: [Next.js](https://nextjs.org/) (App Router)
- **Language**: TypeScript
- **Styling**: Tailwind CSS & Custom Pixel Aesthetics
...
1. **Clone the repository:**
   ```bash
   git clone git@github.com:thisisbigmike/chimikinz.git
   cd chimikinz
   ```
...
- **X (Twitter)**: [@chimikinzonape](https://x.com/chimikinzonape)
